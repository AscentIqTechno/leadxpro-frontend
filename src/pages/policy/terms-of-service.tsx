...
const TermsOfService: React.FC = () => {
    useEffect(() => {
        document.title = "LeadReachXpro | Terms & Conditions";
    }, []);
    ...
    return (
        ...
        <div className="min-h-screen bg-gray-900 py-20 px-4">
            <div className="max-w-4xl mx-auto bg-gray-800 rounded-lg shadow-lg p-10">
                ...
                <p className="text-gray-300 mb-6 text-center">Last updated on Nov 22 2025</p>

                <p className="text-gray-100 mb-4">
                    For the purpose of these Terms and Conditions, the term "we", "us", "our" used anywhere on this page shall mean <span className="font-semibold text-yellow-500">AASHUTOSH KUMAR SINGH</span>, whose registered/operational office is village post talimapur Gopalganj BIHAR 841407. "You", "your", "user", "visitor" shall mean any natural or legal person who is visiting our website and/or agreed to purchase from us.
                </p>
                ...
                <ul className="list-disc list-inside text-gray-200 space-y-2 mb-6">
                    ...
                    <li>You may not create a link to our website from another website or document without AASHUTOSH KUMAR SINGH's prior written consent.</li>
